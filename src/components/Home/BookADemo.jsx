          ...
          <form className="mt-8 space-y-6">
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" id="first-name" placeholder="e.g Dominic" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
              </div>
              <div>
                <label htmlFor="last-name" className="block text-sm font-semibold text-gray-600 mb-1">LAST NAME</label>
                <input type="text" id="last-name" placeholder="e.g Praise" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <input type="email" id="email-address" placeholder="e.g dominic@mail.com" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
            </div>
