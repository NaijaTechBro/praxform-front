          ...
          <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-xl border border-gray-100">
            <form action="#" method="POST" className="space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <FormInput id="first-name" label="First Name" placeholder="e.g Dominic" />
                <FormInput id="last-name" label="Last Name" placeholder="e.g Praise" />
              </div>

              <FormInput id="phone-number" label="Phone Number" placeholder="000 000 000" />
              <FormInput id="email" label="Email Address" type="email" placeholder="e.g dominic@mail.com" />
