      ...
      <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg max-w-4xl w-full">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-b pb-4 border-gray-200">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Vendor ACH/Direct Deposit Authorization Form</h1>
            <p className="text-sm text-gray-500 mt-1">City of Thomasville Accounts Payable</p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g. praisedominic@mail.com"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm placeholder-gray-400 p-2"
                />
              </div>
